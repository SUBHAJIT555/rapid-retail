    ...
    content = (
      <>
        <div className="col-12 mb-30">
          <div className="tp-section-title-wrapper-2 text-center">
            <span className="tp-section-title-pre-2">{siteInfo.domain}</span>
            <h2 className="tp-section-title-2">Shop by Category</h2>
            <p>
              Mobile accessories, smart gadgets, fashion, books, stationery &
              more
            </p>
          </div>
        </div>
