...
const MailSuccessPage = () => {
  return (
    <Wrapper>
      <SEO pageTitle="Quote Request Sent" />
      <HeaderTwo style_2={true} />
      <CommonBreadcrumb title="Quote Request Sent" subtitle="Thank you" center={true} />
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              <div className="tp-checkout-place white-bg p-5">
                ...
                <p className="mb-4">
                  We have received your request and will get back to you with a quote shortly.
                </p>
